...
error_count = 0
finish_count = 0
xy_task_name = ["领至高20元外卖红包", "浏览指定频道好物", "搜一搜推荐商品", "去浏览全新好物", "浏览推荐的国补商品", "去支付宝领积分", "去淘宝签到领红包", "去蚂蚁庄园逛一逛", "去逛一逛芭芭农场", "去支付宝农场领水果", "去蚂蚁森林逛一逛", "去百度逛一逛", "去百度极速版逛一逛", "去饿了么果园领水果", "薅羊毛赚话费", "去天猫拿红包", "逛一逛淘宝人生", "去淘特领好礼", "上夸克天天领现金", "去淘金币赢20亿", "去快手极速版领红包", "去神奇鱼塘领能量", "去淘宝闪购果园领水果", "去头条玩一玩", "去淘宝闪购抽免单卡", "去逛一逛淘金币", "逛花花卡翻卡赢大奖", "去百度地图逛一逛", "618去淘金币赢20亿", "去逛一逛斗地主", "去闲鱼小程序抽大奖", "去苏宁金融赚金币", "去成就中心签到拿周边", "去淘宝闪购逛一逛", "逛逛淘宝闪购天天免单"]
